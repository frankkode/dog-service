...
1. To allow the user to search pre-defined dog services for any given location in sweden and neibour countries.
   2.Based upon the location entered, google API retrieve company location details, contact details, website links and reviews.
   3.to be User friendly and simple to use.
   4.To display the information in a clear and concise manner.
   5.Translation of the web using google translator
...
[A demo of the site is available at](https://frankkode.github.io/dog-service/)
...
[MDBootstrap](https://mdbootstrap.com/) - this was used on contact form and address map.
...
- Esily detects the location (once the user search for services) and displays all nearby services.
...
- Social media icons: The social media icons in the footer section have all been tested to make sure they are linked correctly and work fine. The “\_blank” attribute have also been tested on all of them to make sure that when they are clicked, a new window is open rather than navigating away from the web app.
...
The web app content was checked and tested to make sure that there was error.
...
Click this link to go to the projects GitHub Repositry.
Click the green Clone or download dropdown at the top right, just above the list if files and commits.
...
The background image, the loved dogs images and taken from free image website unsplash and slightly edited by me through an image editor.
